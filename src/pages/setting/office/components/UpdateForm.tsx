...
const UpdateForm: React.FC<UpdateFormProps> = (props) => {
  ...
  form.setFieldsValue({
    ...props.values,
    officeAddress:[props.values.office_province_code,props.values.office_city_code,props.values.office_area_code],
    officeSignAddress:[props.values.office_sign_province_code,props.values.office_sign_city_code,props.values.office_sign_area_code],
  })
